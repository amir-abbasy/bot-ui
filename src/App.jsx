...
// import test_data from "./data/2022-05-15.json";
// import test_data from "./data/2022-06-01.json";
// import test_data from "./data/2022-06-15.json";
...
// import test_data from "./data/2022-08-15.json";
import botConfig from "./botConfig";
const data_offet = 0;
const data_len = 200; //700
...
function App() {
  ...
  async function getOhlcv() {
    ...
    //   "https://rest.coinapi.io/v1/ohlcv/BINANCE_SPOT_BTC_USDT/history?period_id=15MIN&limit=1000&time_start=2022-09-01T00:00:00",
    //   {
    //     method: "GET",
    //     headers: {
    ...
    const modifyData = ohlcv
      .slice(tradeConfig.data_offet, tradeConfig.data_len)
      .map((_) => ({
